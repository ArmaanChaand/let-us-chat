...
export default function Home(){
    ...
    return(
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            ...
            Create a room or join one. Create a room and set a password and then share a link and password to your partner.
            Remember this chat is not End-to-end encrypted.
            </p>
